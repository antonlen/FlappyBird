...
namespace FlappyBird
{
    public class Sprite
    {
        ...
        public virtual Vector2 Origin { get => SourceRectangle.Size.ToVector2() / 2;}
        ...
        public virtual Rectangle Hitbox
        {
            get
            {
                //new Rectangle((Position - Origin * Scale).ToPoint(), ScaledSize.ToPoint());
                
                    return new Rectangle((int)(Position.X - Origin.X * Scale.X), (int)(Position.Y - Origin.Y * Scale.Y), (int)ScaledSize.X, (int)ScaledSize.Y);
        ...
        public Sprite(Texture2D texture, Vector2 position, Rectangle sourceRectangle, Vector2 scale, Color color, SpriteEffects effects, float rotation, float layerDepth)
        {
            Texture = texture;
            //  Origin = origin;
            Position = position;
